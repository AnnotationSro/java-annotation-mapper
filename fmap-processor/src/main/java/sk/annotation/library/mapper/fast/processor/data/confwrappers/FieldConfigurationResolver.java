package sk.annotation.library.mapper.fast.processor.data.confwrappers;
...
public class FieldConfigurationResolver {
	...
	final private FastMapper fastMapper;

	public FieldConfigurationResolver (FastMapper fastMapper, List<MapperFieldConfig> configurations) {
		if (configurations == null) configurations = Collections.emptyList();

		this.fastMapper = fastMapper;
...
//
	...
	*/
	...
	private ConfigErrorReporting findDefautlReport() {
		if (fastMapper!=null && fastMapper.defaultErrorConfig()!=null) return fastMapper.defaultErrorConfig();
